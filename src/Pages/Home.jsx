...
const Home = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-gray-100 text-gray-900' }`}>
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, index) => (
              <div
                key={index}
                className={`rounded-lg p-4 h-80 animate-pulse ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredRoommates.map((roommate) => (
              ...
              >
                <div className={`relative h-48 ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <img
                    src={roommate.image}
                    alt={roommate.name}
      ...
      <section className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-50'} py-16 mb-16`}>
        <div className="container mx-auto px-4">
          <h2 className={`text-3xl font-bold text-center mb-12 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-800'}`}>How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className={`${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-md text-center`}>
              <div className={`${theme === 'dark' ? 'bg-blue-900' : 'bg-blue-100'} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`}>
                <svg className={`w-8 h-8 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-md text-center`}>
              <div className={`${theme === 'dark' ? 'bg-green-900' : 'bg-green-100'} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`}>
                <svg className={`w-8 h-8 ${theme === 'dark' ? 'text-green-300' : 'text-green-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-md text-center`}>
              <div className={`${theme === 'dark' ? 'bg-purple-900' : 'bg-purple-100'} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`}>
                <svg className={`w-8 h-8 ${theme === 'dark' ? 'text-purple-300' : 'text-purple-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="container mx-auto px-4 pb-16">
        <h2 className={`text-3xl font-bold text-center mb-12 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-700'}`}>Success Stories</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className={`${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-md relative`}>
            <div className={`absolute -top-4 -left-4 text-6xl ${theme === 'dark' ? 'text-gray-800' : 'text-gray-200'}`}>“</div>
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>New York, NY</p>
              </div>
            </div>
          ...
          <div className={`${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-md relative`}>
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Austin, TX</p>
              </div>
            </div>
            <p className={theme === 'dark' ? 'text-gray-200' : 'text-gray-700'}>
